        ...
        <div className="pb-12 md:pb-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
            ...
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-gray-200),var(--color-indigo-200),var(--color-gray-50),var(--color-indigo-300),var(--color-gray-200))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
              من أول عملية بيع لحد معرفة أرباحك.
            </h2>
            <p className="text-lg text-indigo-200/65">
              سجّل عملياتك وتابع شغلك وراجع حساباتك من مكان واحد.
            </p>
          </div>
          {/* Spotlight items */}
              ...
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950">
                ...
                <div className="p-5">
                  ...
                  <p className="text-gray-200">
                    سجّل البيع وخلي كل عملية محفوظة ومنظمة.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950">
                ...
                <div className="p-5">
                  ...
                  <p className="text-gray-200">
                    راجع المبيعات والمحافظ وتابع حركة شغلك أول بأول.
                  </p>
                </div>
              </div>
            </a>
            ...
            >
              <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950">
                ...
                <div className="p-5">
                  ...
                  <p className="text-gray-200">
                    راجع الأقساط والديون وشوف أرباحك من التقارير.
                  </p>
                </div>
              </div>
            </a>
